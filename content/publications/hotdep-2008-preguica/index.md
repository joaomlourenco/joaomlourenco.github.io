...
authors: ["Nuno Preguiça", "Rodrigo Rodrigues", "Cristóvão Honorato", "**João M. Lourenço**"]
publication_types: ["1"]
...
featured: true
publication: "Proceedings of the Fourth Conference on Hot Topics in System Dependability 9-9"
links:
  - icon_pack: fas
    icon: scroll
    name: Link
