...
authors: ["Bruno C. Teixeira", "**João M. Lourenço**", "Eitan Farchi", "Ricardo J. Dias", "Diogo G. Sousa"]
publication_types: ["1"]
...
featured: true
publication: "Proceedings of the 8th Workshop on Parallel and Distributed Systems: Testing, Analysis, and Debugging 26-36"
links:
  - icon_pack: fas
    icon: scroll
    name: Link
